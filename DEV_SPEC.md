...
|---------|---------|------|---------|------|
| A1 | 初始化目录树与最小可运行入口 | [x] | 2025-02-21 |  |
| A2 | 引入 pytest 并建立测试目录约定 | [x] | 2026-02-21 |  |
| A3 | 配置加载与校验（Settings） | [x] | 2026-02-21 |  |

#### 阶段 B：Libs 可插拔层

| 任务编号 | 任务名称 | 状态 | 完成日期 | 备注 |
|---------|---------|------|---------|------|
| B1 | LLM 抽象接口与工厂 | [x] | 2026-02-21 |  |
| B2 | Embedding 抽象接口与工厂 | [x] | 2026-02-21 |  |
| B3 | Splitter 抽象接口与工厂 | [x] | 2026-02-22 |  |
| B4 | VectorStore 抽象接口与工厂 | [x] | 2026-02-22 |  |
| B5 | Reranker 抽象接口与工厂（含 None 回退） | [x] | 2026-02-22 |  |
